...
class UpcomingMovies {
    ...
    private static final String[] m_name = {
       "COCO", "Salma's Big Wish","The Lion King ", "Pirates of The Sillicon Valley ", "The Billion Dollar Code", "Mission Mangal", 
       "Bhaag Milkha Bhaag ", "Munjya"
    };

    private static final String[] m_path = {
        "https://www.lajajakids.com/wp-content/uploads/2017/12/coco.jpg",
        "https://m.media-amazon.com/images/S/pv-target-images/6c97fb2a08fc31fb9f98628c503261aab39359624c74bfbf30ba6976cba7716b._SX1080_FMjpg_.jpg",
        "https://w0.peakpx.com/wallpaper/608/682/HD-wallpaper-the-lion-king-3d-edition-king-edition-3d-the-lion.jpg",
       "https://www.tvinsider.com/wp-content/uploads/2022/10/pirates-of-silion-valley.jpg",
       "https://occ-0-8407-114.1.nflxso.net/dnm/api/v6/Qs00mKCpRvrkl3HZAN5KwEL1kpE/AAAABSDRIOHe4WMlqwKPKK8Z_XnXdv1A8QP2Mtk28mAj_1gNkBd8nbJfPnDrgFOTFUQTx1Rh93sNHR-CDUq5aTVvTUMNQ2WTcgU20abjTc6xadho_e7ey6YHtW-_d9VLYBTLKeZqrA.jpg?r=809",
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQly-fOjLG2kEEYr2XlncHLUxBSU2-SybSVAw&s",
      "https://ushus.wordpress.com/wp-content/uploads/2013/07/bhaag-milkha-bhaag-poster.jpg ",
       "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQEZx4Of6iYlEzRKDZFmAUKH9LDl9lITcqDqA&s ",
    };
   ...
   + "                 \r\n" + 
    ...
    private static final String[] m_trailer = {
        "https://youtu.be/969WVyvgzx4 ", "https://youtu.be/VQtImxhxW6U?t=3 ", "https://youtu.be/lFzVJEksoDY?t=1 ", "https://youtu.be/08x8NZ86Gp0?t=5 ",
        " https://youtu.be/iDvPvqImb-4?t=4", "https://youtu.be/q10nfS9V090?t=5", "https://youtu.be/0nR9JS2WsNg?t=3", "https://youtu.be/8X3uF80H5LU?t=8"
    };

    private static final String[] m_date = {
      "2024-24-09",  "2024-20-09", "2024-10-10", "2024-11-10", "2024-12-11", "2024-28-09", "2024-12-10", "2024-29-10" 
    };

    private static final String[] m_time = {
        "12:30 PM",  "4:00 PM", " 3:45 PM", "2:00 PM", "2:30 PM", "3:00 PM", "11:30 AM", "1:00 PM"
      };
      ...
      public void code()
      {
        SwingUtilities.invokeLater(() -> {
            ...
            for (int i = 0; i < m_name.length; i++) {
                ...
                movieCard.setBackground(new Color(230, 230, 255));
                ...
                // Add movie image
                try {
                    URL imageUrl = new URL(m_path[index]);
                    ImageIcon imageIcon = new ImageIcon(imageUrl);
                    Image image = imageIcon.getImage().getScaledInstance(1000, 500, Image.SCALE_SMOOTH);
                ...
                JLabel dateLabel = new JLabel("Release Date:-  " + m_date[index] +  "\n   Time -: "  + m_time[index] );
            ...
            prevButton.setPreferredSize(new Dimension(140, 40));
...
class Homepage extends JFrame implements InnerMainProgram {
    ...
    Homepage() {
        ...
        images[0] = new ImageIcon("C:\\bloody daddy.jpg");
        images[1] = new ImageIcon("C:\\stree2.jpg");
        images[2] = new ImageIcon("C:\\badnewz.jpg");
        images[3] = new ImageIcon("C:\\kalki.jpg");
        images[4] = new ImageIcon("C:\\munjya.jpg");
